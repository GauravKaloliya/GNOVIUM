...
export const diffEndpoints: Endpoint[] = [
  {
    ...
    response: j({
      data: [
        { type: 'added', entity_id: 'fa82a0b1-12c8-47fb-ba2e-ff6a39226cb3', block_id: '4ef014a4-569d-4cf9-98fe-d2784860b263', content: { text: 'New section' } },
        { type: 'removed', entity_id: 'fa82a0b1-12c8-47fb-ba2e-ff6a39226cb3', block_id: '5a3978e0-dfeb-475d-911e-5451dd808dad', content: { text: 'Old section' } },
        { type: 'modified', entity_id: 'fa82a0b1-12c8-47fb-ba2e-ff6a39226cb3', block_id: '4ef014a4-569d-4cf9-98fe-d2784860b263', left: { text: 'Before' }, right: { text: 'After' } },
      ],
    }),
  },
];
