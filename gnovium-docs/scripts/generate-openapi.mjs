...
const ENDPOINTS_META = [
  ...
  { id: 'auth-register', module: 'Auth', method: 'POST', path: '/auth/register', summary: 'Register a user', description: 'Creates a user account. Passwords must be at least 8 characters.', tags: ['Auth'], operationId: 'authRegister', requestBody: { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/AuthRegisterRequest' } } } } },
  { id: 'auth-login', module: 'Auth', method: 'POST', path: '/auth/login', summary: 'Log in', description: 'Authenticates with email and password.', tags: ['Auth'], operationId: 'authLogin', requestBody: { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/AuthLoginRequest' } } } } },
  { id: 'auth-refresh', module: 'Auth', method: 'POST', path: '/auth/refresh', summary: 'Refresh access token', description: 'Uses a valid refresh token to issue a new access token.', tags: ['Auth'], operationId: 'authRefresh' },
  { id: 'auth-logout', module: 'Auth', method: 'POST', path: '/auth/logout', summary: 'Log out', description: 'Revokes the current refresh-token session.', tags: ['Auth'], operationId: 'authLogout' },
  { id: 'auth-me', module: 'Auth', method: 'GET', path: '/auth/me', summary: 'Get current user', description: 'Returns the authenticated user\'s profile.', tags: ['Auth'], operationId: 'authMe' },
  { id: 'auth-me-update', module: 'Auth', method: 'PATCH', path: '/auth/me', summary: 'Update current user', description: 'Partially updates the authenticated user\'s profile.', tags: ['Auth'], operationId: 'authMeUpdate', requestBody: { content: { 'application/json': { schema: { $ref: '#/components/schemas/AuthMeUpdateRequest' } } } } },
  ...
  { id: 'workspaces-delete', module: 'Workspaces', method: 'DELETE', path: '/workspaces/{id}', summary: 'Delete workspace', description: 'Soft-deletes a workspace.', tags: ['Workspaces'], operationId: 'workspacesDelete', parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } }] },
  ...
  { id: 'entities-delete', module: 'Entities', method: 'DELETE', path: '/entities/{id}', summary: 'Delete entity', description: 'Soft-deletes an entity. Can be restored.', tags: ['Entities'], operationId: 'entitiesDelete', parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } }] },
  ...
  { id: 'entities-restore', module: 'Entities', method: 'POST', path: '/entities/{id}/restore', summary: 'Restore entity', description: 'Restores a soft-deleted or archived entity.', tags: ['Entities'], operationId: 'entitiesRestore', parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } }] },
  ...
  { id: 'entities-versions', module: 'Entities', method: 'GET', path: '/entities/{id}/versions', summary: 'List entity versions', description: 'Returns version history for an entity.', tags: ['Entities'], operationId: 'entitiesVersions', parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } }] },
  ...
  { id: 'blocks-delete', module: 'Blocks', method: 'DELETE', path: '/blocks/{id}', summary: 'Delete block', description: 'Soft-deletes a block.', tags: ['Blocks'], operationId: 'blocksDelete', parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } }] },
  ...
  { id: 'relations-delete', module: 'Relations', method: 'DELETE', path: '/relations/{id}', summary: 'Delete relation', description: 'Soft-deletes a relation edge.', tags: ['Relations'], operationId: 'relationsDelete', parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } }] },
  ...
  { id: 'comments-delete', module: 'Comments', method: 'DELETE', path: '/comments/{id}', summary: 'Delete comment', description: 'Soft-deletes a comment.', tags: ['Comments'], operationId: 'commentsDelete', parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } }] },
  ...
  { id: 'versions-changesets-list', module: 'Versions', method: 'GET', path: '/versions/changesets', summary: 'List changesets', description: 'Returns changesets for a branch.', tags: ['Versions'], operationId: 'versionsChangesetsList' },
  { id: 'versions-changesets-create', module: 'Versions', method: 'POST', path: '/versions/changesets', summary: 'Create changeset', description: 'Creates a changeset.', tags: ['Versions'], operationId: 'versionsChangesetsCreate' },
  { id: 'versions-snapshots-list', module: 'Versions', method: 'GET', path: '/versions/snapshots', summary: 'List snapshots', description: 'Returns named snapshots.', tags: ['Versions'], operationId: 'versionsSnapshotsList' },
  { id: 'versions-snapshots-create', module: 'Versions', method: 'POST', path: '/versions/snapshots', summary: 'Create snapshot', description: 'Creates a named snapshot.', tags: ['Versions'], operationId: 'versionsSnapshotsCreate' },
  { id: 'versions-entity-snapshot', module: 'Versions', method: 'POST', path: '/versions/entities/{entity_id}/snapshot', summary: 'Snapshot entity', description: 'Captures current entity state.', tags: ['Versions'], operationId: 'versionsEntitySnapshot', parameters: [{ name: 'entity_id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } }] },
  { id: 'versions-entities-list', module: 'Versions', method: 'GET', path: '/versions/entities/{entity_id}', summary: 'List entity versions', description: 'Returns version history.', tags: ['Versions'], operationId: 'versionsEntitiesList', parameters: [{ name: 'entity_id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } }] },
  { id: 'versions-blocks-list', module: 'Versions', method: 'GET', path: '/versions/blocks/{block_id}', summary: 'List block versions', description: 'Returns block version history.', tags: ['Versions'], operationId: 'versionsBlocksList', parameters: [{ name: 'block_id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } }] },
  { id: 'versions-compare', module: 'Versions', method: 'GET', path: '/versions/compare', summary: 'Compare versions', description: 'Field-level diff between versions.', tags: ['Versions'], operationId: 'versionsCompare' },
  { id: 'versions-restore', module: 'Versions', method: 'POST', path: '/versions/restore/{version_id}', summary: 'Restore version', description: 'Restores entity to a saved version.', tags: ['Versions'], operationId: 'versionsRestore', parameters: [{ name: 'version_id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } }] },
  { id: 'diffs-compare', module: 'Diffs', method: 'POST', path: '/diffs/compare', summary: 'Compare snapshots', description: 'Structured diff between snapshots or branches.', tags: ['Diffs'], operationId: 'diffsCompare' },
  ...
  { id: 'files-delete', module: 'Files', method: 'DELETE', path: '/files/{id}', summary: 'Delete file', description: 'Soft-deletes file metadata.', tags: ['Files'], operationId: 'filesDelete', parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } }] },
  { id: 'files-presign', module: 'Files', method: 'POST', path: '/files/presign', summary: 'Presigned URL', description: 'Returns S3 presigned upload URL.', tags: ['Files'], operationId: 'filesPresign' },
  ...
  { id: 'sync-list', module: 'Sync', method: 'GET', path: '/sync', summary: 'List sync operations', description: 'Returns sync operations.', tags: ['Sync'], operationId: 'syncList' },
  { id: 'sync-create', module: 'Sync', method: 'POST', path: '/sync', summary: 'Create sync op', description: 'Creates a sync operation.', tags: ['Sync'], operationId: 'syncCreate' },
  { id: 'sync-get', module: 'Sync', method: 'GET', path: '/sync/{id}', summary: 'Get sync op', description: 'Retrieves a sync operation.', tags: ['Sync'], operationId: 'syncGet', parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } }] },
  { id: 'sync-ack', module: 'Sync', method: 'POST', path: '/sync/{id}/ack', summary: 'Acknowledge sync', description: 'Marks sync as applied.', tags: ['Sync'], operationId: 'syncAck', parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } }] },
  ...
  { id: 'jobs-list', module: 'Jobs', method: 'GET', path: '/jobs', summary: 'List jobs', description: 'Returns background job records.', tags: ['Jobs'], operationId: 'jobsList' },
  { id: 'jobs-create', module: 'Jobs', method: 'POST', path: '/jobs', summary: 'Create job', description: 'Creates a background job.', tags: ['Jobs'], operationId: 'jobsCreate' },
  { id: 'jobs-running', module: 'Jobs', method: 'POST', path: '/jobs/{id}/running', summary: 'Mark running', description: 'Marks job as running.', tags: ['Jobs'], operationId: 'jobsRunning', parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } }] },
  { id: 'jobs-completed', module: 'Jobs', method: 'POST', path: '/jobs/{id}/completed', summary: 'Mark completed', description: 'Marks job as completed.', tags: ['Jobs'], operationId: 'jobsCompleted', parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string', format: 'uuid' } }] },
  { id: 'backups-export', module: 'Backups', method: 'POST', path: '/backups/export', summary: 'Export workspace', description: 'Exports all workspace data as JSON.', tags: ['Backups'], operationId: 'backupsExport' },
  { id: 'backups-import', module: 'Backups', method: 'POST', path: '/backups/import', summary: 'Import workspace', description: 'Imports workspace data from JSON.', tags: ['Backups'], operationId: 'backupsImport' },
];
