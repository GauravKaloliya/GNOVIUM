...
class PropertyCreateSchema(Schema):
    workspace_id = fields.UUID(required=True)
    entity_type_id = fields.UUID(load_default=None, allow_none=True)
    name = fields.Str(required=True)
...
class EntityCreateSchema(Schema):
    workspace_id = fields.UUID(required=True)
    entity_type_id = fields.UUID(required=True)
...
class BlockCreateSchema(Schema):
    ...
    parent_block_id = fields.UUID(load_default=None, allow_none=True)
...
class BlockUpdateSchema(Schema):
    parent_block_id = fields.UUID(allow_none=True)
...
class RelationCreateSchema(Schema):
    workspace_id = fields.UUID(required=True)
    source_entity_id = fields.UUID(required=True)
    target_entity_id = fields.UUID(required=True)
...
class BranchCreateSchema(Schema):
    workspace_id = fields.UUID(required=True)
    parent_branch_id = fields.UUID(load_default=None, allow_none=True)
    name = fields.Str(required=True)
    description = fields.Str(load_default=None)
...
class ChangesetCreateSchema(Schema):
    branch_id = fields.UUID(required=True)
    snapshot_id = fields.UUID(load_default=None, allow_none=True)
    message = fields.Str(load_default=None)


class MergeBranchSchema(Schema):
    source_branch_id = fields.UUID(required=True)
    target_branch_id = fields.UUID(required=True)
...
class NotificationCreateSchema(Schema):
    ...
    entity_id = fields.UUID(load_default=None, allow_none=True)
...
class JobCreateSchema(Schema):
    workspace_id = fields.UUID(load_default=None, allow_none=True)
...
class CommentCreateSchema(Schema):
    workspace_id = fields.UUID(required=True)
    entity_id = fields.UUID(load_default=None, allow_none=True)
    block_id = fields.UUID(load_default=None, allow_none=True)
    parent_comment_id = fields.UUID(load_default=None, allow_none=True)
