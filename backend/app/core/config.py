...
class CloudConfig(Config):
    ...
    CORS_ORIGINS = env_list("CORS_ORIGINS", "https://www.gnovium.com")
    ALLOWED_HOSTS = env_list("ALLOWED_HOSTS", "www.gnovium.com")
...
def get_config():
    mode = os.getenv("GNOVIUM_MODE", "local").strip().lower()
    if mode == "cloud":
        return CloudConfig
    return LocalConfig
